...
<link rel="icon" href="${path1}/resources/images/favicon2.png" />
<link rel="shortcut icon" href="${path1}/resources/images/favicon2.png" />
...
<!-- font -->
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100..900&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Sorts+Mill+Goudy:ital@0;1&display=swap" rel="stylesheet">
